...
## 战斗报告 ########################################################################
##
##decesased: array of decesased characters, 0 means alive,1 means dead, 2 means
##dead in a star section
##clues  a array of discovered clues
##flags three boolean valus
...
screen titanroster():
    frame:
        ...
        xalign 0.5
        yalign 0.5
        add "titan.jpg" xalign 0.0 yalign 0.0 zoom .6
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("战斗报告") action ShowMenu('battlereport')
            textbutton _("战场状况") action ShowMenu('titanroster')
