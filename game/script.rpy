...
label chapter_9:
    ...
    n "你还记得五年前的惨剧。超大型巨人的攻击和玛利亚之墙的沦陷。人类不得不退缩至领土深处，并且因此损失了五分之一的人口。"
    n "你当时还是个孩子。而五年前的惨剧就是你加入训练兵团的原因。三年的训练艰苦而残酷，但是有不少好同学。"
    #艾伦训练成功
    n "发誓要将巨人一个不剩地驱逐出去的艾伦。"
    #三笠立体机动装置林间飞行
    n "身体素质超强的三笠。"
    #阿明三人组讨论
    n "个子矮小但是头脑极佳的阿尔敏。"
    ...
    n "大家都很信任的大哥莱纳。"
    #阿尼冷漠泰拳姿势
    n "阿妮虽然沉默寡言难以接近，但是她作为士兵的能力很强，你愿意和她进入同一个兵团。"
    #科尼莎夏功夫
    n "莎夏和科尼两个笨蛋也是很好玩的人。"
    #女神喂面包
    n "对大家都很好的克里斯塔。"
    #贝贝奇怪睡姿
    n "个高而懦弱的贝尔托特。你好奇他们都打算加入哪个兵团。"
    #让让子艾伦打架，情侣在一旁秀恩爱
    n "你想起让和那对情侣汉娜和弗朗兹有点烦人。不过一想到一旦你要和他们分开，还是不免有些伤感。"
    n "（如果你想不起来同学们的样子可以随时打开战斗报告）"
    n "你经历了三年恐怖的训练，终于在昨天毕业了。明天你就可以去申请自己想加入的兵团，并成为真正的士兵了。"
    # 现实对应兵团logo
    n "有驻屯兵团，保护墙内的居民。"
    # logo
    n "宪兵团，保护内城和王。"
    #logo
    n "和调查兵团，去墙外和巨人战斗。"
    n "你思考过想要加入的兵团，以及同学们想加入的兵团。"
    n "进入宪兵团很难，只有每一期的前十名才能进入宪兵团。"
    n "不过现在，你只是在特罗斯特街区游荡。"
    n "你的确有一些比较琐碎的任务，比如在驻屯兵团的指导下巡逻（看看有没有巨人进攻），清洁武器之类的。"
    n "不过你现在没有什么训练任务，因此可以再特罗斯特街区相对自由地游荡。也许他们想让你在成为正式士兵之前先放松一下吧。"
    n "接着这次放松的机会，你的同学们似乎也都跑到镇子里闲逛了。"
